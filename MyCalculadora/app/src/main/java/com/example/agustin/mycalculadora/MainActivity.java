package com.example.agustin.mycalculadora;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.div:
                if (entero2==0)
                    Toast.makeText(getApplicationContext(),"No se puede dividir por 0! Por favor ingrese otro numero.",Toast.LENGTH_SHORT).show();
                else
                    rta=entero1/entero2;
                break;
        }
